...
city = Label(top_frame, font=("Times New Roman", 12), text="Симферополь", bg="coral")
desc = Label(top_frame, font=("Times New Roman", 12), bg="coral")
temp = Label(middle_frame, font=("Times New Roman", 46), bg="ghost white")
city.pack(pady=0)
desc.pack(pady=0)
