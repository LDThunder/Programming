...
1. Изучил библиотеку Tkinter. Затем записал следующие функции:
* Поля ячеек.
* Расположения шариков в ячейках.
* Перемещения шариков (запоминание нажатой ячейки, и цвета шарика в ней).
* Проверка линий (горизонтальных, вертикальных, диагональных).
* Очищение линий с шариками одинакового цвета.
...
class Game:
    def __init__(self):
        ...
        self.balraw = {
            ...
            .crop(b)
            .resize(zoom),
            "orange": Image.open("image/ball-orange.png")
            .convert("RGBA")
            .crop(b)
            .resize(zoom),
...
<p align="center"> <img src="./image/screen.png"> </p>

<p align="center">Рисунок 1 - Сам процесс игры <br>

## Вывод:

Выполнил все поставленные цели и задачи, получил опыт в создании игр с простым графическим интерфейсом, а именно, при разработке игры Lines на языке Python. Изучил, как использовать графическую библиотеку TKinter.